...
export default function dubArtistsPage() {
  const [favorites, setFavorites] = useState<Artist[]>([]);
  
  const dubArtists = artistsData.filter((artist) => artist.genre === "dub");
  ...
  return (
    <div>
      ...
      <main style={{ padding: 20 }}>
        <h1 style={{fontSize: '2rem'}}>Dub Artists</h1>
        
        {dubArtists.length === 0 ? (
          <p>No Dub artists found.</p>
        ) : (
